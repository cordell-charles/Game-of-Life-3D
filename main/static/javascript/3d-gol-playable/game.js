...
class Game {
    constructor(settings) {
        ...
        this.world = new gameEnv(this.settings.world.width, this.settings.world.height, this.settings.world.depth);
        ...
        this.sceneManager.addLight({x: 1, y:-1, z:-2}, 0xFF0000, 1);
