class cellDetails {
    ...
    getCellNeighbors(cell) {
        ...
        const cell4 = this.getCellPosition(cell.position.x + 1,cell.position.y + 2,cell.position.z);
        const cell5 = this.getCellPosition(cell.position.x + 1,cell.position.y + 2,cell.position.z + 1)
        const cell6 = this.getCellPosition(cell.position.x + 1,cell.position.y + 2,cell.position.z - 1)
        const cell7 = this.getCellPosition(cell.position.x - 1,cell.position.y + 2,cell.position.z);
        const cell8 = this.getCellPosition(cell.position.x - 1,cell.position.y + 2,cell.position.z + 1)
        const cell9 = this.getCellPosition(cell.position.x - 1,cell.position.y + 2,cell.position.z - 1)
